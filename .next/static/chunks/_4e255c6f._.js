...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/products`).then({
                "Home.useEffect": (res)=>res.json()
            }["Home.useEffect"]).then({
                "Home.useEffect": (data)=>setProducts(data.products || [])
            }["Home.useEffect"]); // Adjust based on your API shape
        }
    }["Home.useEffect"], []);
